...
class HasTypeTypingRule[TermType0, TypeType0, Term <: TermType0, T0 <: TypeType0](e: Term, t1: T0)(implicit typeSystem: TypeSystem[TermType0, TypeType0]) extends TypingRule{
